...
def save_results(results, file_path="results/lineworld_policy_metrics_configs.csv"):
...
if __name__ == "__main__":
    print("Running LineWorld Policy Metrics Evaluation...")
    results = run_metrics()
    save_results(results)
    print("Results saved to results/lineworld_policy_metrics_configs.csv")
    print("\nFinal Results:")
